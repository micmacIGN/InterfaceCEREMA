...
flecheDroite = ''
flecheGauche = ''
...
class CalibrationGPS:                       # Paramètres : fenetre maitre,Nom du fichier image, liste des noms des boutons, dictionnaire des points déjà placés
    ...
    def suivant(self): # photo suivante sur la saisie des points/polylignes/polylignes 
        ...
        try :
            ...
            self.root.destroy()
            CalibrationGPS(fenetre,suivante,self.points,self.dicoPointsJPG)
        except:
            self.quitter()
...
class Interface(ttk.Frame):
    ...
    def __init__(self, fenetre, **kwargs):
        ...
        def updateExpert():
            menuExpert.entryconfig(7, label=_("Définir la longueur du préfixe des photos ; %s") % (self.nbCaracteresDuPrefixe))
...
##                    ('Figee','Figee','disabled')        
    ...
    # Tapioca
        ...
        self.nePasLancerTapas = False   # si tapioca mulscale est interrompu aprés la première échelle : devient True

    # TAPAS

        self.modeCheckedTapas.set('RadialBasic')                # mode par défaut depuis la v 2.23 du 14 mars 2016 (RadialExtended, RadialStd,RadialBasic...
    ...
    # mieux que Mic Mac qui prend par défaut le masque de l'image maitre avec le nom prédéfini masq
        ...
        self.modeCheckedMalt.set('AperoDeDenis')                # par défaut (GeoImage,AperoDedenis,UrbanMNE,Ortho
...
##                    return
        ...
        self.encadre(_("Copie des photos en cours... Patience")) #  pour éviter le redémarage
    ...
    # Chantier terminé, l'utilisateur peur décider de le débloquer en conservant les résultats de tapas ou supprimer tous les résultats
        ...
        if self.etatDuChantier in (0,1,2,6,7,35):                   # sinon self.etatDuChantier vaut 4 et on va direct à Malt ou C3DC
...
############################ Calibration par axe, plan et métrique
    ...
    # anormal : chantier planté lors de la dernière éxécution de tapioca/Tapas : on propose le déblocage mais on sort dans tous les cas
        ...
        if self.etatDuChantier==3:	# En principe ne doit pas arriver : plantage en cours de tapas ou Tapioca
            ...
            if retour==-1 or retour==2:                         # 2 ou -1 : abandon ou fermeture de la fenêtre par la croix
                return
            if retour==0:
                self.nettoyerChantier()                          # le chantier est noté comme de nouveau modifiable, les points homologues sont supprimés
                ...
                return
            if retour==1:
                self.nettoyerChantierApresTapioca()                          # le chantier est noté comme de nouveau modifiable, les points homologues sont conservés
    ...
    # poursuite du traitement ou arrêt suivant demande utilisateur
        ...
        if self.etatDuChantier==4:                              # Chantier arrêté après Tapas
            ...
            if retour==2:                                       # b3 : débloquer le chantier, conserver les points homologues
                self.nettoyerChantierApresTapioca()             # l'etatDuChantier passe à 35 !
                self.afficheEtat()
                return 

        if self.etatDuChantier==35:                              # Chantier arrêté arrété aprés tapioca, points homoloques conservés
            ...
            if retour==0 :
                self.etatDuChantier = 2                 
            # si retour == 1 : on laisse l'étatduchantier à 35, le temps de sauter tapioca
        ...
        # arrêt au milieu de Tapioca :

        if self.nePasLancerTapas:
            self.nePasLancerTapas = False
            return
    ...
    def suiteMicmac(self):                                      # poursuite après tapas, avec ou sans arrêt après tapas, retour au menu
        ...
        if  retour == -1 :
            if self.choixDensification.get()=="C3DC":    
                ...
                texte += _("option geoImage ou AperoDeDenis si la scène est un objet (statue...)")+"\n"+"\n"
...
# subprocess.Popen("TASKKILL /F /PID {pid} /T".format(pid=self.exe.pid)) # https://stackoverflow.com/questions/4789837/how-to-terminate-a-python-subprocess-launched-with-shell-true/4791612#4791612
    ...
    def lanceTapas(self):
        ...
        if self.photosPourCalibrationIntrinseque.__len__()>0:       # s'il y a des photos pour calibration intrinsèque
            ...
            # supprimer les résultats d'un Tapas précédent :
    ...
    def nettoyerChantierApresTapas(self):     # Le chantier est remis aprés Tapas, prêt pour une nouvelle densification
        ...
        self.enregistreChantier()
        self.sauveParam()
        self.ajoutLigne("\n ****** " + _("Chantier réinitialisé aprés Orientation sur demande utilsiateur. Prochain départ : densification")+"\n")
        self.ecritureTraceMicMac()
    ...
    def nettoyerChantierApresTapioca(self):     # Le chantier est remis aprés Tapioca
        ...
        self.enregistreChantier()
        self.sauveParam()
        self.ajoutLigne("\n ****** " + _(" Chantier réinitialisé aprés points homologues sur demande utilsiateur. Prochain départ : Orientation (Tapas)")+"\n")
        self.ecritureTraceMicMac()
    ...
    def copieDansRepertoireDeTest(self,nom):
        ...
        oschdir(self.repTest)

    def retirerPhotos(self):
        ...
        if len(self.selectionPhotosAvecChemin)>0:
            ...
            [self.lesTagsExif.pop(e,None) for e in dico if e[1] in self.photosAvecChemin]
            self.photosPourCalibrationIntrinseque = [e for e in self.photosPourCalibrationIntrinseque if e in self.photosAvecChemin]
            self.photosCalibrationSansChemin = [os.path.basename(f) for f in self.photosPourCalibrationIntrinseque]
            dico = dict(self.dicoPointsGPSEnPlace)
            print("self.dicoPointsGPSEnPlace=",self.dicoPointsGPSEnPlace)
            [self.dicoPointsGPSEnPlace.pop(key,None) for key in dico if os.path.basename(key[1]) not in self.photosSansChemin]
            ...
            for e in self.photosSansChemin:
                ajouter = [f for f in self.listeDesMasques if e in f]
            ...
            [self.dicoLigneHorizontale.pop(key,None) for key in dico if key[1] in self.photosAvecChemin]
            dico = dict(self.dicoLigneVerticale)
            [self.dicoLigneVerticale.pop(key,None) for key in dico if key[1] in self.photosAvecChemin]
            dico = dict(self.dicoCalibre)
            [self.dicoCalibre.pop(key,None) for key in dico if key[1] in self.photosAvecChemin]            
    ...
    def retirerUnePhoto(self,photo):
            self.photosAvecChemin = [e for e in self.photosAvecChemin if e!=photo]
    ...
    def ajoutPointsGPSAutreChantier(self):
        ...
        # création des fichiers xml dico-appuis et mesures-appuis

        self.finCalibrationGPSOK()
    ...
    def conseils(self):
        aide2 = _("Interface graphique pour lancer les modules de MICMAC : quelques conseils.") + "\n\n"+\
                ...
                _("                        9) Avec C3DC nous avons constaté des échecs avec le message 'cAppliMICMAC::SauvMemPart File for _compl.xml'.") + "\n"       +\
    ...
    def commencer(self):
        ...
        self.encadre (aide3,50,aligne='left')
    ...
    def aPropos(self):
        ...
        self.encadre (aide5,aligne='center')
...
########################################## Outils divers (raccourcis clavier, infobulle, afficher un dico de points....)
    ...
    def regroupementSuivantPointsHomologues(self,rep="Homol"):
        ...
        if rep=="Homol_SRes":
            dico = {k: v for k, v in dico.items() if v}
        for p in self.photosSansChemin:             # recherche pour chaque photo du groupe d'appartenance
            ...
            else: groupe[p] = p                     # il faut ajouter les groupes avec une seule photo isolée (ignorés dans le répertoire rep):
...
########################################################   Modifier les options par défaut
    ...
    def restaureOptions(self):
        ...
        try:                                                                        # s'il y a une sauvegarde alors on la restaure
            ...
            self.file.set(r[5])           
            self.modeTapioca.set(r[6])
            print("self.modeCheckedMalt.set=",self.modeCheckedMalt.get())
...
def oschdir(rep):
    ...
    if os.path.isdir(rep):
        ...
        texte = _("Repertoire non trouvé : %s .") % (rep)
        tkinter.messagebox.showwarning("AperoDeDenis : Avertissement",texte)
...
if __name__ == "__main__":
    while continuer:
        ...
        # pour n'exécuter qu'un fois les fonctions à lancer au lancement de l'interface
        ...
        # la commande photoImage ne être appelée qu'après créatin de la fenêtre Tk
        ...
        # boucle tant que la fenetre interface existre
